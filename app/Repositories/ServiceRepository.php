...
class ServiceRepository
{
    ...
    public function update($data, $service)
    {
        if (!isset($data['sms'])) $data['sms'] = false;
        //// swap priority
        $firstPriority=Service::where('priority',$data['priority'])->first();
        $secondPriority=Service::where('id',$service->id)->first();
        $firstPriority->priority=$secondPriority->priority;
        $firstPriority->save();
        //// end swap priority
    ...
    public function delete($data, $service)
    {
        ...
        Storage::delete('public/recall_service_' . $service->id . '_display.json');
        $service->delete();
    }
}
