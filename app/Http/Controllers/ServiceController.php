...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Storage::put('public/recall_service_' . $service->id . '_display.json', json_encode([]));
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function display(Request $request)
    {
        try {
            ...
            {
                $i++;
                ${'file'.$i} = 'storage/app/public/service_' . $value . '_display.json';
                ${'service_'.$i}=$value;
            }
        ...
        return view('display.index', ['date' => Carbon::now()->toDateString(), 'settings' => Setting::first(), 'file' => $file,'file1'=>$file1,'file2'=>$file2,'file3'=>$file3,'service_1'=>$service_1,'service_2'=>$service_2,'service_3'=>$service_3]);
    }
}
