...
class DisplayController extends Controller
{
    public function showDisplayUrl()
    {
        ...
        return view('display.index', ['service'=>$service,'date' => Carbon::now()->toDateString(), 'settings' => Setting::first(),'file'=>'storage/tokens_for_display.json','file1'=>$file1,'file2'=>$file2,'file3'=>$file3,'service_1'=>$service_1,'service_2'=>$service_2,'service_3'=>$service_3]);
    }
    public function showRecallDisplayUrl()
    {
        ...
        // return view('display.index', ['service'=>$service,'date' => Carbon::now()->toDateString(), 'settings' => Setting::first(),'file'=>'storage/tokens_for_display.json']);
        return view('display.recall-display', ['service'=>$service,'date' => Carbon::now()->toDateString(), 'settings' => Setting::first(),'file'=>'storage/tokens_for_display.json','file1'=>$file1,'file2'=>$file2,'file3'=>$file3,'service_1'=>$service_1,'service_2'=>$service_2,'service_3'=>$service_3]);
    }
}
