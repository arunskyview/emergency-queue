...
Route::middleware(['setLocale'])->group(function () {
    ...
    Route::get('recall-display', [DisplayController::class, 'showRecallDisplayUrl'])->name('recall-display');
    Route::get('get-tokens-for-display', [CallController::class, 'getTokensForDisplay'])->name('get-tokens-for-display');
    Route::post('check-patient-mrn',[TokenController::class,'checkMrn'])->name('check-patient-mrn');
    // });
});
