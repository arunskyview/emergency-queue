                            ...
                            <form id="service_form" method="post" action="{{route('services.store')}}">
                                ...
                                <div class="row">
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s3">
                                            <label for="priority">{{__('messages.service_page.add service priority')}}</label>
                                            <input id="priority" name="priority" type="number" value="{{old('priority')}}" data-error=".priority">
                                            <div class="priority">
                                    ...
                                    <div class="row form_align">
                                        <div class="col s3">
                                            ...
                                            <input id="color" class="form-control input-field" style="width: 100%" name="color" type="color" value="{{old('color')}}" data-error=".color">
                                            <div class="color">
                                                @if ($errors->has('color'))
