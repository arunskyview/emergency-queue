                            ...
                            <form id="service_form" method="post" action="{{route('services.update',[$service->id])}}">
                                ...
                                <div class="row">
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s3">
                                            <label for="priority">{{__('messages.service_page.service priority')}}</label>
                                            <input id="priority" name="priority" type="number" value="{{$service->priority}}" data-error=".priority">
                                            <div class="priority">
                                                @if ($errors->has('priority'))
                                                <span class="text-danger errbk">{{ $errors->first('priority') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row form_align">
                                        <div class="col s3">
                                            <label for="color">{{__('messages.service_page.color')}}</label>
                                            <input id="color" class="form-control input-field" style="width: 100%" name="color" type="color" value="{{$service->color}}" data-error=".color">
                                            <div class="color">
                                                @if ($errors->has('color'))
                                    ...
                                    <div class="row form_align">
                                        <div class="input-field col s3">
                                            ...
                                            <label>{{__('messages.service_page.Ask Patient File No For Token')}}</label>
                                            <div class="ask_name">
                                        ...
                                        <div class="input-field col s3">
                                            ...
                                            <label>{{__('messages.service_page.Patient File No is required')}}</label>
