                                    ...
                                    <div class="col s12">
                                        <table id="page-length-option" class="display dataTable">
                                            <thead>
                                                <tr>
                                                    <th width="10px">#</th>
                                                    <th>{{__('messages.service_page.color')}}</th>
                                                    <th>{{__('messages.service_page.name')}}</th>
                                                    <th>{{__('messages.service_page.service priority')}}</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td><i class="material-icons" style='background-color: {{$service->color}};border-radius: 39px;width: 23px;'>circle</i></td>
                                                    <td>{{$service->name}}</td>
