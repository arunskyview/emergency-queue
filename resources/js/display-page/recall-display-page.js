...
if (document.getElementById("recall-display-page")) {
    var app = {
        data() {
            return {
                time_out: null,
        ...
        methods: {
            ...
            getTokensFirst() {
                axios.get(`${window?.JLToken.get_tokens_for_display_first_url}?time=${new Date().getTime()}`).then(res => {
                    ...
                    if (!this.from_first && res.data && res.data.length && res.data[0].called_date == this.today && ((res.data[0].status == 'RECALL' && res.data[0].re_call_status_id != 2) || (res.data[0].re_call_status_id >= 1 && res.data[0].called_date == this.today))) {
                    ...
                    else if (this.from_first && res.data && res.data.length && res.data[0].called_date == this.today && ((res.data[0].status == 'RECALL' && res.data[0].re_call_status_id != 2) || (res.data[0].re_call_status_id >= 1 && res.data[0].called_date == this.today))) {
            ...
            processQueue1() {
                ...
                if (!this.isProcessing && !this.isPlaying && this.queue1.length) {
                    ...
                    else if (this.queue1.length && ((this.queue1[0][0].id != this.tokens1[0]?.id) || (this.tokens1 == null && this.queue1[0][0].call_status_id == null) || (this.tokens1 == null || this.queue1[0][0].re_call_status_id >= 1))) {
            ...
            processQueue2() {
                ...
                if (!this.isProcessing && !this.isPlaying && this.queue2.length) {
                    ...
                    else if (this.queue2.length && ((this.queue2[0][0].id != this.tokens2[0]?.id) || (this.tokens2 == null && this.queue2[0][0].call_status_id == null) || (this.tokens2 == null && this.queue2[0][0].re_call_status_id >= 1))) {
            ...
            getTokensThird() {
                axios.get(`${window?.JLToken.get_tokens_for_display_third_url}?time=${new Date().getTime()}`).then(res => {
                    ...
                    if (!this.from_first && res.data && res.data.length && res.data[0].called_date == this.today && ((res.data[0].status == 'RECALL' && res.data[0].re_call_status_id != 2)) || (res.data[0].re_call_status_id >= 1 && res.data[0].called_date == this.today)) {
                        // if (!this.from_first && res.data && res.data.length && res.data[0].called_date == this.today && (res.data[0].status == 'RECALL')) {
                        ...
                        // else if (this.from_first && res.data && res.data.length && res.data[0].called_date == this.today && (res.data[0].status == 'RECALL')) {
            ...
            processQueue3() {
                if (!this.isProcessing && !this.isPlaying && this.queue3.length) {
                    ...
                    else if (this.queue3.length && ((this.queue3[0][0].id != this.tokens3[0]?.id) || (this.tokens3 == null && this.queue3[0][0].call_status_id == null) && (tokens3[0]?.is_recalled == 0 && this.queue3[0][0].re_call_status_id == 1))) {
            ...
            getTokensFromFile1() {
                axios.get(`${window?.JLToken.get_tokens_from_file1}?time=${new Date().getTime()}`).then(res => {
                    if (res.data && res.data.called_tokens && res.data.tokens_for_call && this.date && window.JLToken.selectedService1) {
                        if ((res.data.called_tokens.length && moment(res.data.called_tokens[0].started_at).format('YYYY-MM-DD') == this.date) || (res.data.recall_tokens.length && moment(res.data.recall_tokens[0].created_at).format('YYYY-MM-DD') == this.date && res.data.recall_tokens[0].recall==1)) {
                            this.called_tokens = res.data.called_tokens.filter(val => val.service_id == window.JLToken.selectedService1);
                            this.tokens_for_next_to_call1 = res.data.recall_tokens.filter(val => val.service_id == window.JLToken.selectedService1);
            ...
            getTokensFromFile2() {
                axios.get(`${window?.JLToken.get_tokens_from_file1}?time=${new Date().getTime()}`).then(res => {
                    if (res.data && res.data.called_tokens && res.data.recall_tokens && this.date && window.JLToken.selectedService2) {
                        if ((res.data.called_tokens.length && moment(res.data.called_tokens[0].started_at).format('YYYY-MM-DD') == this.date) || (res.data.recall_tokens.length && moment(res.data.recall_tokens[0].created_at).format('YYYY-MM-DD') == this.date && res.data.recall_tokens[0].recall==1)) {
                            this.called_tokens = res.data.called_tokens.filter(val => val.service_id == window.JLToken.selectedService2);
                            this.tokens_for_next_to_call2 = res.data.recall_tokens.filter(val => val.service_id == window.JLToken.selectedService2);
            ...
            getTokensFromFile3() {
                axios.get(`${window?.JLToken.get_tokens_from_file1}?time=${new Date().getTime()}`).then(res => {
                    if (res.data && res.data.called_tokens && res.data.recall_tokens && this.date && window.JLToken.selectedService3) {
                        if ((res.data.called_tokens.length && moment(res.data.called_tokens[0].started_at).format('YYYY-MM-DD') == this.date) || (res.data.recall_tokens.length && moment(res.data.recall_tokens[0].created_at).format('YYYY-MM-DD') == this.date && res.data.recall_tokens[0].recall==1)) {
                            this.called_tokens = res.data.called_tokens.filter(val => val.service_id == window.JLToken.selectedService3);
                            this.tokens_for_next_to_call3 = res.data.recall_tokens.filter(val => val.service_id == window.JLToken.selectedService3);
            ...
            showCategoryTimer() {
                ...
                // console.log(this.called_tokens);
                    this.time_after_called = 0;
    ...
    Vue.createApp(app).mount('#recall-display-page')
